      ...
      <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        ...
        >
          <div className="flex flex-col md:flex-row md:mx-6">
            <Link onClick={() => setIsOpen(false)} to="/test1" className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0">
              test1
            </Link>
            <a
